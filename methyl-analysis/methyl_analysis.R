...
source('~/methyl_analysis/methyl_analysis_functions.R')
source('~/methyl_analysis/SLIMcodes.R')

debugging <- TRUE
debugNrows <- 1000000
debugNwindows <- 100000

normalSampleFile <- "~/Documents/gene_rearrange/bs/bs-input/LC_3961/LC_3961_CpG_methylation_summary.ucsc.txt.gz"
normalSampleName <- "LC_3961"
cancerSampleFile <- "~/Documents/gene_rearrange/bs/data/LC_41/LC_41_CpG_methylation_summary.ucsc.txt.gz"
cancerSampleName <- "LC_41"
outputDir <- "/mnt/methyl/out/LC_3961_vs_LC_41/"
